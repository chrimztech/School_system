...
export const SCHOOL_LEADERSHIP_ROLES: readonly Role[] = [
  "super_admin",
  "school_admin",
  "principal",
  "deputy_head",
...
export function isSchoolLeadershipRole(role: Role | undefined): boolean {
  return role !== undefined && SCHOOL_LEADERSHIP_ROLES.includes(role);
}
...
export const MODULE_MATRIX = [
  ...
  "ptc", "my-children", "system-backup",
] as const;

export const ACCESS: Record<Role, Record<string, Access>> = {
  super_admin: { dashboard: true, ptc: true, students: true, teachers: true, timetable: true, attendance: true, assessments: true, "report-card": true, fees: true, communication: true, discipline: true, library: true, transport: true, calendar: true, reports: true, settings: true, access: true, onboarding: true, accounting: true, health: true, hostel: true, inventory: true, hr: true, alumni: true, admissions: true, procurement: true, facilities: true, "enterprise-analytics": true, security: true, compliance: true, "vendor-management": true, "district-management": true, reporting: true, "incident-management": true, "user-management": true, "policy-library": true, "risk-register": true, "staff-development": true, "student-welfare": true, "fee-structure": true, bursaries: true, "duty-roster": true, activities: true, "visitor-log": true, canteen: true, "strategic-plan": true, "lost-found": true, "platform-ops": true, "tenant-success": true, "plan-catalog": true, "support-desk": true, "platform-config": true, "tenant-lifecycle": true, "platform-audit": true, "revenue-ops": true, "data-governance": true, "partner-management": true, "contract-center": true, "status-center": true, "approval-center": true, "developer-console": true, "tenant-workbench": true, "my-children": true, "system-backup": true },
  school_admin: { dashboard: true, ptc: true, students: true, teachers: true, timetable: true, attendance: true, assessments: true, "report-card": true, fees: true, communication: true, discipline: true, library: true, transport: true, calendar: true, reports: true, settings: true, access: true, onboarding: false, accounting: true, health: true, hostel: true, inventory: true, hr: true, alumni: true, admissions: true, procurement: true, facilities: true, "enterprise-analytics": true, security: true, compliance: true, "vendor-management": true, "district-management": false, reporting: true, "incident-management": true, "user-management": true, "policy-library": true, "risk-register": true, "staff-development": true, "student-welfare": true, "fee-structure": true, bursaries: true, "duty-roster": true, activities: true, "visitor-log": true, canteen: true, "strategic-plan": true, "lost-found": true, "platform-ops": false, "tenant-success": false, "plan-catalog": false, "support-desk": false, "platform-config": false, "tenant-lifecycle": false, "platform-audit": false, "revenue-ops": false, "data-governance": false, "partner-management": false, "contract-center": false, "status-center": false, "approval-center": false, "developer-console": false, "tenant-workbench": false, "my-children": true, "system-backup": false },
  teacher: { dashboard: true, ptc: "read", students: "read", teachers: "read", timetable: "read", attendance: true, assessments: true, "report-card": true, fees: false, communication: true, discipline: true, library: "read", transport: false, calendar: "read", reports: "read", settings: false, access: false, onboarding: false, accounting: false, health: "read", hostel: "read", inventory: false, hr: false, alumni: "read", admissions: false, procurement: false, facilities: "read", "enterprise-analytics": false, security: false, compliance: "read", "vendor-management": false, "district-management": false, reporting: "read", "incident-management": "read", "user-management": false, "policy-library": "read", "risk-register": "read", "staff-development": "read", "student-welfare": true, "fee-structure": false, bursaries: false, "duty-roster": "read", activities: true, "visitor-log": false, canteen: "read", "strategic-plan": "read", "lost-found": true, "platform-ops": false, "tenant-success": false, "plan-catalog": false, "support-desk": false, "platform-config": false, "tenant-lifecycle": false, "platform-audit": false, "revenue-ops": false, "data-governance": false, "partner-management": false, "contract-center": false, "status-center": false, "approval-center": false, "developer-console": false, "tenant-workbench": false, "my-children": true, "system-backup": false },
  hod: { dashboard: true, ptc: "read", students: true, teachers: "read", timetable: true, attendance: "read", assessments: "read", "report-card": "read", fees: false, communication: true, discipline: true, library: "read", transport: false, calendar: "read", reports: "read", settings: false, access: false, onboarding: false, accounting: false, health: "read", hostel: "read", inventory: false, hr: false, alumni: "read", admissions: false, procurement: false, facilities: "read", "enterprise-analytics": false, security: false, compliance: "read", "vendor-management": false, "district-management": false, reporting: "read", "incident-management": "read", "user-management": false, "policy-library": "read", "risk-register": false, "staff-development": "read", "student-welfare": true, "fee-structure": false, bursaries: false, "duty-roster": "read", activities: "read", "visitor-log": false, canteen: false, "strategic-plan": false, "lost-found": true, "platform-ops": false, "tenant-success": false, "plan-catalog": false, "support-desk": false, "platform-config": false, "tenant-lifecycle": false, "platform-audit": false, "revenue-ops": false, "data-governance": false, "partner-management": false, "contract-center": false, "status-center": false, "approval-center": false, "developer-console": false, "tenant-workbench": false, "my-children": true, "system-backup": false },
  finance: { dashboard: true, ptc: true, students: "read", teachers: false, timetable: false, attendance: "read", assessments: false, "report-card": false, fees: true, communication: "read", discipline: false, library: false, transport: true, calendar: "read", reports: true, settings: false, access: false, onboarding: false, accounting: true, health: false, hostel: false, inventory: true, hr: true, alumni: "read", admissions: "read", procurement: true, facilities: "read", "enterprise-analytics": true, security: true, compliance: "read", "vendor-management": true, "district-management": false, reporting: true, "incident-management": false, "user-management": false, "policy-library": "read", "risk-register": true, "staff-development": false, "student-welfare": false, "fee-structure": true, bursaries: true, "duty-roster": false, activities: false, "visitor-log": false, canteen: true, "strategic-plan": "read", "lost-found": false, "platform-ops": false, "tenant-success": false, "plan-catalog": false, "support-desk": false, "platform-config": false, "tenant-lifecycle": false, "platform-audit": false, "revenue-ops": false, "data-governance": false, "partner-management": false, "contract-center": false, "status-center": false, "approval-center": false, "developer-console": false, "tenant-workbench": false, "my-children": true, "system-backup": false },
  parent: { dashboard: true, ptc: "read", students: false, teachers: false, timetable: false, attendance: false, assessments: false, "report-card": "read", fees: "read", communication: true, discipline: false, library: false, transport: false, calendar: "read", reports: false, settings: false, access: false, onboarding: false, accounting: false, health: false, hostel: false, inventory: false, hr: false, alumni: false, admissions: false, procurement: false, facilities: false, "enterprise-analytics": false, security: false, compliance: false, "vendor-management": false, "district-management": false, reporting: false, "incident-management": false, "user-management": false, "policy-library": false, "risk-register": false, "staff-development": false, "student-welfare": false, "fee-structure": false, bursaries: false, "duty-roster": false, activities: false, "visitor-log": false, canteen: false, "strategic-plan": false, "lost-found": false, "platform-ops": false, "tenant-success": false, "plan-catalog": false, "support-desk": false, "platform-config": false, "tenant-lifecycle": false, "platform-audit": false, "revenue-ops": false, "data-governance": false, "partner-management": false, "contract-center": false, "status-center": false, "approval-center": false, "developer-console": false, "tenant-workbench": false, "my-children": false, "system-backup": false },
  principal: { dashboard: true, ptc: true, students: true, teachers: true, timetable: true, attendance: true, assessments: true, "report-card": true, fees: true, communication: true, discipline: true, library: true, transport: true, calendar: true, reports: true, settings: true, access: true, onboarding: false, accounting: true, health: true, hostel: true, inventory: true, hr: true, alumni: true, admissions: true, procurement: true, facilities: true, "enterprise-analytics": true, security: true, compliance: true, "vendor-management": true, "district-management": false, reporting: true, "incident-management": true, "user-management": true, "policy-library": true, "risk-register": true, "staff-development": true, "student-welfare": true, "fee-structure": true, bursaries: true, "duty-roster": true, activities: true, "visitor-log": true, canteen: true, "strategic-plan": true, "lost-found": true, "platform-ops": false, "tenant-success": false, "plan-catalog": false, "support-desk": false, "platform-config": false, "tenant-lifecycle": false, "platform-audit": false, "revenue-ops": false, "data-governance": false, "partner-management": false, "contract-center": false, "status-center": false, "approval-center": false, "developer-console": false, "tenant-workbench": false, "my-children": true, "system-backup": false },
  deputy_head: { dashboard: true, ptc: true, students: true, teachers: true, timetable: true, attendance: true, assessments: true, "report-card": true, fees: true, communication: true, discipline: true, library: true, transport: true, calendar: true, reports: true, settings: true, access: true, onboarding: false, accounting: true, health: true, hostel: true, inventory: true, hr: true, alumni: true, admissions: true, procurement: true, facilities: true, "enterprise-analytics": true, security: true, compliance: true, "vendor-management": true, "district-management": false, reporting: true, "incident-management": true, "user-management": true, "policy-library": true, "risk-register": true, "staff-development": true, "student-welfare": true, "fee-structure": true, bursaries: true, "duty-roster": true, activities: true, "visitor-log": true, canteen: true, "strategic-plan": true, "lost-found": true, "platform-ops": false, "tenant-success": false, "plan-catalog": false, "support-desk": false, "platform-config": false, "tenant-lifecycle": false, "platform-audit": false, "revenue-ops": false, "data-governance": false, "partner-management": false, "contract-center": false, "status-center": false, "approval-center": false, "developer-console": false, "tenant-workbench": false, "my-children": true },
  career_guidance: { dashboard: true, ptc: false, students: "read", teachers: false, timetable: false, attendance: "read", assessments: "read", "report-card": "read", fees: false, communication: true, discipline: "read", library: false, transport: false, calendar: true, reports: false, settings: false, access: false, onboarding: false, accounting: false, health: false, hostel: false, inventory: false, hr: false, alumni: false, admissions: false, procurement: false, facilities: false, "enterprise-analytics": false, security: false, compliance: false, "vendor-management": false, "district-management": false, reporting: false, "incident-management": false, "user-management": false, "policy-library": false, "risk-register": false, "staff-development": false, "student-welfare": true, "fee-structure": false, bursaries: false, "duty-roster": false, activities: "read", "visitor-log": false, canteen: false, "strategic-plan": false, "lost-found": false, "platform-ops": false, "tenant-success": false, "plan-catalog": false, "support-desk": false, "platform-config": false, "tenant-lifecycle": false, "platform-audit": false, "revenue-ops": false, "data-governance": false, "partner-management": false, "contract-center": false, "status-center": false, "approval-center": false, "developer-console": false, "tenant-workbench": false, "my-children": true, "system-backup": false },
};
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    // (see tenant.tsx's `value` useMemo). Depending on it here previously caused this effect
    // to tear down and re-run every time a session-changed hydration itself touched tenant
    // state, cascading into a "Maximum update depth exceeded" render loop on login.
