...
function AdmissionsPage() {
  ...
  // transitional cohorts still applying/enrolling under the old naming — see the matching
  // comment on formatGrade/gradeLabelToNumber in lib/tenant.tsx for the raw-value offsets.
